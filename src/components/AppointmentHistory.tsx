...
export function AppointmentHistory({ appointments }: AppointmentHistoryProps) {
  ...
  return (
    <div>
      <h3 className="text-xl font-semibold text-gray-900 mb-6">Appointment History</h3>
          ...
          <div key={appointment._id} className="bg-white border border-gray-200 rounded-lg p-6">
            <div className="flex justify-between items-start mb-4">
              <div>
                ...
                <p className="text-gray-600">
                  ...
                  {appointment.veterinarian?.specialization && ` - ${appointment.veterinarian.specialization}`}
                </p>
              </div>
            ...
            {appointment.veterinarianNotes && (
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <span className="text-sm font-medium text-blue-900">Veterinarian Notes:</span>
